            ...
            <div className="light" id="theme-container">
                <div className='login-page'>
                    ...
                    <div className="login-form">
                        <input className="key-input" placeholder="> private key" onChange={e => setNsec(e.target.value)}></input>
                        <NavLink className="login-button" to="/chats" state={{nsec: nsec}}>Login</NavLink>
                    </div>
                    ...
                    <div></div>
                    <img id="change-theme" src={dark} onClick={() => {
                        let container = document.querySelector("#theme-container")
                        let button = document.querySelector("#change-theme");
                        if (container.classList.value.includes('light')) {
                            container.classList.remove("light");
                            container.classList.add("dark");
                            button.setAttribute("src",light);
                        }
                        else {
                            container.classList.remove("dark");
                            container.classList.add("light");
                            button.setAttribute("src",dark);
                        }
                    }}></img>
                </div>
            </div>
